...
<div id="experience-timeline">
    <div data-date="September 2023 – September 2024">
        <h3>Muthamizharasi</h3>
        <h4>Full Stack Developer</h4>
        <p>
           A Hardworking and passionate developer.
        </p>
    </div>
</div>
```
...
<div class="education-block">
    ...
    <span class="education-date">Sept 2020 - Sept 2024</span>
...
<div class="project">
    ...
    <div class="project-info">
        <h3>Distance calculator using AI and Python</h3>
        <p>
            To view project...
        </p>
